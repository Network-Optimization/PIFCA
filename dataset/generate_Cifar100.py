...
np.random.seed(1)
num_clients = 10
dir_path = "Cifar100_randomsample/"
...
def generate_dataset(dir_path, num_clients, niid, balance, partition):
    ...
    if partition == 'bernoulli_overlap':
        ...
        alpha_val = 0.3
        train_data, test_data, statistic, class_probs = bernoulli_overlap_partition(
        ...
        save_file_with_probs(config_path, train_path, test_path, train_data, test_data, num_clients,
                             num_classes, statistic, class_probs, seed, niid, balance, partition)
    else:
