...
#     ]
    ...
    # commands = [
    #     # OrganAMNIST_0.1 数据集
    #     "python main1.py -data OrganAMNIST_0.1 -m CNN -algo FedAvg -gr 100 -lr 0.001 -ncl 11 -dev cuda -did 0,1",
    ...
    #     # OrganAMNIST_1 数据集
    #     "python main1.py -data OrganAMNIST_1 -m CNN -algo FedAvg -gr 100 -lr 0.001 -ncl 11 -dev cuda -did 0,1",
    ...
    #     # OrganAMNIST_100 数据集
    #     "python main1.py -data OrganAMNIST_100 -m CNN -algo FedAvg -gr 100 -lr 0.001 -ncl 11 -dev cuda -did 0,1",
...
class TaskExecutor:
    def __init__(self, base_workers: int = 3, gpu_memory_reserved: float = 0.3, max_workers_limit: int = 8):
        self.base_workers = base_workers
...
if __name__ == "__main__":
    datasets = ["FashionMNIST_0.1_S","MNIST_0.1_S","EMNIST_0.1_S","Cifar10_0.1_S"]
    algorithms = [
    ...
    for dataset in datasets:
        for algo in algorithms:
            cmd = f"python main1.py -data {dataset} -m CNN -algo {algo} -gr 100 -lr 0.001 -ncl 10 -dev cuda -did 0,1"
            commands.append(cmd)
    
    executor = TaskExecutor(base_workers=3, gpu_memory_reserved=0.3, max_workers_limit=8)
    executor.execute_tasks(commands)